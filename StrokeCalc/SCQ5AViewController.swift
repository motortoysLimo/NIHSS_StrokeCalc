...
class SCQ5AViewController: SCBaseViewController,UITableViewDelegate, UITableViewDataSource {
...
//        self.timerButton.setShadowLayer()
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                ...
                detailCell.titleLabel.attributedText = NSMutableAttributedString().boldHeader(text: "5A. Motor - Left Arm")
                ...
                cell.bigImage.image = #imageLiteral(resourceName: "leftArm0")
                return cell
            } else {
            ...
            if indexPath.row == 0 {
                let cell = tableView.dequeueReusableCell(withIdentifier: "bigimagecell", for: indexPath) as! SCBigImageTableViewCell
                cell.bigImage.image = #imageLiteral(resourceName: "leftArm1")
            ...
            if indexPath.row == 0 {
                let cell = tableView.dequeueReusableCell(withIdentifier: "bigimagecell", for: indexPath) as! SCBigImageTableViewCell
                cell.bigImage.image = #imageLiteral(resourceName: "leftArm2")
                return cell
            } else {
                let cell = tableView.dequeueReusableCell(withIdentifier: "answercell", for: indexPath) as! SCAnswerTableViewCell
            ...
            if indexPath.row == 0 {
                let cell = tableView.dequeueReusableCell(withIdentifier: "bigimagecell", for: indexPath) as! SCBigImageTableViewCell
                cell.bigImage.image = #imageLiteral(resourceName: "leftArm3")
                return cell
            } else {
                let cell = tableView.dequeueReusableCell(withIdentifier: "answercell", for: indexPath) as! SCAnswerTableViewCell
            ...
            if indexPath.row == 0 {
                let cell = tableView.dequeueReusableCell(withIdentifier: "bigimagecell", for: indexPath) as! SCBigImageTableViewCell
                cell.bigImage.image = #imageLiteral(resourceName: "leftArm4")
                return cell
            } else {
                let cell = tableView.dequeueReusableCell(withIdentifier: "answercell", for: indexPath) as! SCAnswerTableViewCell
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if indexPath.row != 0 || indexPath.section == 5 {
            ...
            if indexPath.section == 5 { // UN - Untestable
                ...
                testScoreService.setScoresForQuestions(dictionary: [SCQType.Q5A.rawValue: score])
                
                performSegue(withIdentifier: "to5b", sender: self)
            }
        }
    }
    ...
    func performNext() {
        testScoreService.setScoresForQuestions(dictionary: [SCQType.Q5A.rawValue: "UN"])
        performSegue(withIdentifier: "to5b", sender: self)
